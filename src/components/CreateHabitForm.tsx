...
function CreateHabitForm(props: HideForm) {
  const addHabit = useHabitStore((state: HabitsState) => state.addHabit);
  const addHabitEntry = useHabitEntryStore(
    (state: HabitEntriesState) => state.addHabitEntry
  );
  ...
  useEffect(() => {
    setFormData(() => {
      ...
      if (formDataCopy.habitType === "count") {
        formDataCopy.startingCount <= formDataCopy.goalCount
          ? (formDataCopy.countDirection = "up")
          : (formDataCopy.countDirection = "down");
      }
      return formDataCopy;
    });
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group pb-2">
            ...
            >
              ...
              <option value="count">
                Count (e.g. number of words written)
              </option>
            </select>
          </div>
              ...
              <div className="form-group py-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      goalCount: e.target.valueAsNumber,
                    })
                  }
                  type="number"
                  name="goalCount"
